    ...
    items: [
      {
        ...
        children: [
          ...
          { path: '/secao-operacional/crimes-ambientais', label: 'Crimes Ambientais', icon: AlertTriangle },
          { path: '/secao-operacional/crimes-comuns', label: 'Crimes Comuns', icon: Shield },
          { path: '/secao-operacional/atividades-prevencao', label: 'Atividades Prevenção', icon: TreePine },
