              ...
              <TableCard key={registro.id} className="group">
                ...
                <TableCardContent>
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                    ...
                    <TableCardField
                      label="Enquadramento"
                      value={registro.enquadramento?.["Enquadramento"] || '-'}
                    />
                    <TableCardField
                    ...
                    />
                    {registro.qtd_detidos_maior !== undefined && (
                      <TableCardField
                        label="Detidos (Maior)"
                        value={
                          <span className="text-primary font-semibold">
                            {registro.qtd_detidos_maior}
                          </span>
                        }
                      />
                    )}
                    {registro.qtd_detidos_menor !== undefined && (
                      <TableCardField
                        label="Detidos (Menor)"
                        value={
                          <span className="text-primary font-semibold">
                            {registro.qtd_detidos_menor}
                          </span>
                        }
                      />
                    )}
