      ...
      <div className="flex items-center justify-between p-4">
        {isOpen && (
          <div className="flex items-center gap-3">
            <div className="w-14 h-14 rounded-full bg-[#071d49] flex items-center justify-center flex-shrink-0 transition-all duration-300 hover:shadow-[0_0_15px_rgba(255,204,0,0.8)] cursor-pointer">
              <img src={logoSidebar} alt="Logo BPMA" className="w-12 h-12" />
            </div>
