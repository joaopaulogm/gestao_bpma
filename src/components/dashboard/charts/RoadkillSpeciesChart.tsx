...
const RoadkillSpeciesChart: React.FC<SpeciesChartProps> = ({ data }) => {
  return (
    <ChartCard title="Animais Atropelados por Espécie" subtitle="Distribuição de atropelamentos">
...
export default RoadkillSpeciesChart;
