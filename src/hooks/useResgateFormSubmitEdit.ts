...
const prepararDadosParaAtualizacao = async (
  ...
  return {
    ...
    quantidade_adulto: data.quantidadeAdulto || 0,
    quantidade_filhote: data.quantidadeFilhote || 0,
    "quantidade Jovem": data.quantidadeJovem || 0,
    quantidade_total: (data.quantidadeAdulto || 0) + (data.quantidadeFilhote || 0) + (data.quantidadeJovem || 0),
